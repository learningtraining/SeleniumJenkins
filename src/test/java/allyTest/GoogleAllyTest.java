...
public class GoogleAllyTest {
	
	
	WebDriver driver;
	private static final URL scriptURL = GoogleAllyTest.class.getResource("/axe.min.js");
...
//			driver.get("https://www.ea.com/sports");
	...
	public void verifyAmazonAllyTestElement() {
		...
		JSONObject responseJSON =  new AXE.Builder(driver, scriptURL).analyze(driver.findElement(By.partialLinkText("Gmail")));
		JSONArray violations = responseJSON.getJSONArray("violations");
